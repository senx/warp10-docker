...
~~~
  docker run --volume=/var/warp10:/data -p 8080:8080 -p 8081:8081 --name warp10 -d -i warp10io/warp10:x.y.z
~~~

Where `x.y.z` is the image version (the current one being `1.2.16`).
